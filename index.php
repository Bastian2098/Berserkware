    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body modal1">
          ...
          <div class="mb-3 pt-3">
            <input type="text" class="form-control" id="Correo_registro" placeholder="Correo">
          </div>
          <div class="mb-3 pt-3">
            <input type="password" class="form-control" id="clave_registro" placeholder="Clave">
          </div>
          <div class="mb-3 pt-3">
            <input type="password" class="form-control" id="Nombre" placeholder="Repetir Clave">
          </div>
        </div>

        <div class="modal-footer">
          <button type="button" class="btn btn-primary boton_registro ">Registrar</button>
        </div>
      </div>
    </div>
  </div>
